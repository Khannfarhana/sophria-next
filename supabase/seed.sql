...
insert into public.profiles (id, full_name, email, phone) values
  ('00000000-0000-4000-a000-000000000001', 'SophRia Operations', 'ops@sophria.example',        '+1 (437) 967-2334'),
...
------------------------------------------------------------------ drivers
insert into public.drivers (id, user_id, license_number, experience_years, rating, total_earnings, commission_rate, is_available, is_verified) values
  ('00000000-0000-4000-b000-000000000011', '00000000-0000-4000-a000-000000000011', 'ON-DR-44821', 8, 4.9, 18250, 0.20, true,  true),
  ('00000000-0000-4000-b000-000000000012', '00000000-0000-4000-a000-000000000012', 'ON-DR-77310', 5, 4.8, 12940, 0.20, false, true),
  ('00000000-0000-4000-b000-000000000013', '00000000-0000-4000-a000-000000000013', 'ON-DR-90155', 3, 0.0, 0,     0.20, false, false)
on conflict (id) do nothing;
...
insert into public.vehicles (id, name, type, capacity, luggage, base_rate, hourly_rate, features, description, image_url, is_active) values
  ('00000000-0000-4000-c000-000000000001', 'Executive Sedan',    'sedan',     3,  2,  95, 85, array['Mercedes E-Class / Cadillac CT6','Leather interior','Bottled water','Phone chargers'], 'Refined executive sedan for airport transfers, corporate travel, and private city rides.', '/vehicles/sedan.jpg',    true),
  ...
  ('00000000-0000-4000-c000-000000000003', 'Luxury SUV',         'suv',       6,  5, 130,120, array['Cadillac Escalade / GMC Yukon','Seats up to 6','Ample luggage','Winter-ready'],        'Spacious luxury SUV for family transfers, group travel, and extra luggage capacity.',       '/vehicles/suv.jpg',      true),
...
insert into public.bookings
  (id, reference, customer_id, driver_id, vehicle_id, trip_type, pickup_location, dropoff_location, pickup_datetime, duration_hours, flight_number, passenger_count, luggage_count, fare_estimate, driver_payout, passenger_name, passenger_phone, special_requests, status, payment_status, stripe_payment_id)
values
  ('00000000-0000-4000-d000-000000000001', 'SR-7F3A2K', '00000000-0000-4000-a000-000000000002', null,                                   '00000000-0000-4000-c000-000000000001', 'one_way', '100 Front St W, Toronto',            'Toronto Pearson (YYZ)',           '2026-07-02T13:30:00Z', null, null, 1, 2,  95, null, 'Jordan Avery', '+1 (416) 555-0123', 'Meet at the lobby.',                'pending',         'pending',  null),
  ('00000000-0000-4000-d000-000000000002', 'SR-K92BX1', '00000000-0000-4000-a000-000000000003', null,                                   '00000000-0000-4000-c000-000000000002', 'airport', 'Toronto Pearson (YYZ), Terminal 1', 'Ritz-Carlton, 181 Wellington St W','2026-07-03T22:15:00Z', null, 'AC 118', 2, 3, 145, null, 'Priya Nair',   '+1 (647) 555-0456', 'Flight from Vancouver — track.',    'confirmed',       'pending',  null),
  ('00000000-0000-4000-d000-000000000003', 'SR-M5QD7P', '00000000-0000-4000-a000-000000000002', '00000000-0000-4000-b000-000000000011', '00000000-0000-4000-c000-000000000003', 'hourly',  'King West, Toronto',                'As directed (hourly)',            '2026-07-05T15:00:00Z', 4,    null, 4, 2, 440, 88,   'Jordan Avery', '+1 (416) 555-0123', 'Multi-stop: showroom visits.',      'driver_assigned', 'paid',     'pi_mock_6c17'),
  ('00000000-0000-4000-d000-000000000004', 'SR-T1W8RC', '00000000-0000-4000-a000-000000000003', '00000000-0000-4000-b000-000000000012', '00000000-0000-4000-c000-000000000004', 'one_way', 'Casa Loma, 1 Austin Terrace',       'The Carlu, 444 Yonge St',         '2026-06-20T20:00:00Z', null, null, 6, 0, 260, 52,   'Priya Nair',   '+1 (647) 555-0456', 'Wedding party.',                    'completed',       'paid',     'pi_mock_3a91'),
  ('00000000-0000-4000-d000-000000000005', 'SR-Z0H4VN', '00000000-0000-4000-a000-000000000002', null,                                   '00000000-0000-4000-c000-000000000001', 'one_way', 'Union Station, Toronto',            'Mississauga, ON',                 '2026-06-25T12:00:00Z', null, null, 1, 1,  95, null, 'Jordan Avery', '+1 (416) 555-0123', null,                                'cancelled',       'refunded', null)
on conflict (id) do nothing;
...
insert into public.payments (id, booking_id, amount, currency, status, stripe_id) values
  ...
  ('00000000-0000-4000-a100-000000000003', '00000000-0000-4000-d000-000000000003', 440, 'CAD', 'paid',     'pi_mock_6c17')
on conflict (id) do nothing;
